 ...
 * @link       
 *
 * @package  Bz_Import_Export_For_Woo 
 */
if (!defined('ABSPATH')) {
    exit;
}
if(!class_exists('Bz_Import_Export_For_Woo_Basic_Logwriter')){
class Bz_Import_Export_For_Woo_Basic_Logwriter extends Bz_Import_Export_For_Woo_Basic_Log
{
